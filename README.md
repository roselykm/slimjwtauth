...
To get the JWT token (if not using Auth0 token). Remember, in real app, token generation will only given to user who do successful login with username-password to a user database.
